...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.200000);//UVTiling Normal Intensity (Unknown) Desaturation
	Material.ScalarExpressions[1] = float4(0.500000,1.000000,0.850000,0.500000);//Brightnes Metalic Roughness_Strength AO_Strength
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local10 = dot(Local9, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local11 = lerp(Local9,MaterialFloat3(Local10,Local10,Local10),MaterialFloat(Material.ScalarExpressions[0].w));
	MaterialFloat3 Local12 = (Local11 * Material.ScalarExpressions[1].x);
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, Local0, 3);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
	...
	MaterialFloat Local18 = (Local14.r * Material.ScalarExpressions[1].w);
