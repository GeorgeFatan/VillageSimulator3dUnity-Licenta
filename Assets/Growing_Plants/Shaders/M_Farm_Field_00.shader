Shader "Unreal/MI_Farm_Field_00"
{
	Properties
	{
		...
		Material_Texture2D_2( "T_Dirt", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(5.000000,6.000000,6.000000,6.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.911809,-0.410615,-0.410615,-0.410615);//(Unknown)
	Material.VectorExpressions[6] = float4(0.410615,0.911809,0.911809,0.911809);//(Unknown)
	Material.ScalarExpressions[0] = float4(2.000000,0.000000,0.000000,0.800000);//UVTiling Normal Intensity (Unknown) Brightness
	Material.ScalarExpressions[1] = float4(6.000000,5.000000,1.067343,6.706314);//Dirt_H Dirt_U Dirt_Rotation (Unknown)
	Material.ScalarExpressions[2] = float4(0.410615,-0.410615,0.911809,0.000000);//(Unknown) (Unknown) (Unknown) Dirt_Amount
	Material.ScalarExpressions[3] = float4(2.000000,0.500000,20.000000,0.000000);//Roughness_Strength AO_Strength GroundBlend (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local11 = (Parameters.TexCoords[0].xy * Material.VectorExpressions[4].rg);
	MaterialFloat2 Local12 = ((MaterialFloat2(0.50000000,0.50000000) * -1.00000000) + Local11);
	MaterialFloat Local13 = dot(Local12, Material.VectorExpressions[5].rg);
	MaterialFloat Local14 = dot(Local12, Material.VectorExpressions[6].rg);
	MaterialFloat2 Local15 = (MaterialFloat2(0.50000000,0.50000000) + MaterialFloat2(Local13,Local14));
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, Local15, 5);
	MaterialFloat4 Local17 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local15,View.MaterialTextureMipBias));
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 5);
	MaterialFloat Local19 = lerp(0.00000000,Local17.r,Material.ScalarExpressions[2].w);
	MaterialFloat3 Local20 = lerp(Local10,MaterialFloat3(1.00000000,1.00000000,1.00000000),MaterialFloat(Local19));
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local22 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 0);
	MaterialFloat Local24 = (Material.ScalarExpressions[3].x * Local22.g);
	MaterialFloat Local25 = (Material.ScalarExpressions[3].y * Local22.r);
	MaterialFloat2 Local26 = GetPixelPosition(Parameters);
	MaterialFloat Local27 = View.TemporalAAParams.x;
	MaterialFloat2 Local28 = (Local26 + MaterialFloat2(Local27,Local27));
	MaterialFloat Local29 = CustomExpression1(Parameters,Local28);
	MaterialFloat2 Local30 = (Local26 / MaterialFloat2(64.00000000,64.00000000));
	MaterialFloat Local31 = MaterialStoreTexCoordScale(Parameters, Local30, 6);
	MaterialFloat4 Local32 = ProcessMaterialLinearGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_4, Material_Texture2D_4Sampler,Local30,View.MaterialTextureMipBias)).r).rrrr;
	MaterialFloat Local33 = MaterialStoreTexSample(Parameters, Local32, 6);
	MaterialFloat Local34 = (Local32.r * 1.00000000);
	MaterialFloat Local35 = (Local29 + Local34);
	MaterialFloat Local36 = (Local35 / 6.00000000);
	MaterialFloat Local37 = (0.50000000 + Local36);
	MaterialFloat Local38 = (Local37 + -0.50000000);
	MaterialFloat Local39 = (Local38 * Material.ScalarExpressions[3].z);
	...
	PixelMaterialInputs.AmbientOcclusion = Local25;
	PixelMaterialInputs.Refraction = 0;
	PixelMaterialInputs.PixelDepthOffset = Local39;
