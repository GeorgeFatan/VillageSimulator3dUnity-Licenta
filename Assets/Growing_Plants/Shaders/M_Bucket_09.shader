...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[1] = float4(1.293048,0.500000,0.000000,0.000000);//Roughness_Strength AO_Strength (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, Local0, 2);
