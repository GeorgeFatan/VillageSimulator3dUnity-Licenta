Shader "Unreal/MI_Tree_Bark"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_Wood_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Wood_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_Wood_R", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(1.000000,-0.000000,-0.000000,-0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.250000,1.570796,1.000000);//(Unknown) Rotation Angle (0-1) (S) (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(-1.000000,-0.000000,0.200000,0.000000);//(Unknown) (Unknown) Brightness (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local3 = PositiveClampedPow(Local1.rgb,1.00000000);
	...
	MaterialFloat2 Local5 = ((MaterialFloat2(0.50000000,0.50000000) * -1.00000000) + Parameters.TexCoords[0].xy);
	MaterialFloat Local6 = dot(Local5, Material.VectorExpressions[2].rg);
	MaterialFloat Local7 = dot(Local5, Material.VectorExpressions[3].rg);
	MaterialFloat2 Local8 = (MaterialFloat2(0.50000000,0.50000000) + MaterialFloat2(Local6,Local7));
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, Local8, 2);
	MaterialFloat4 Local10 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_1, GetMaterialSharedSampler(Material_Texture2D_1Sampler,View.MaterialTextureBilinearWrapedSampler),Local8));
	MaterialFloat Local11 = MaterialStoreTexSample(Parameters, Local10, 2);
	MaterialFloat3 Local12 = PositiveClampedPow(Local10.rgb,1.00000000);
	MaterialFloat3 Local13 = (Material.ScalarExpressions[1].z * Local12);
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 0);
	MaterialFloat4 Local15 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_2, GetMaterialSharedSampler(Material_Texture2D_2Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
