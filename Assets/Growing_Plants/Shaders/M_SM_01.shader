...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.500000);//UVTiling Normal Intensity (Unknown) Brightness
	Material.ScalarExpressions[1] = float4(1.000000,0.500000,0.850000,0.000000);//Metalic Roughness_Strength AO_Strength (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	...
	MaterialFloat Local14 = (Local12.b * Material.ScalarExpressions[1].x);
	MaterialFloat Local15 = (Material.ScalarExpressions[1].y * Local12.g);
	MaterialFloat Local16 = (Material.ScalarExpressions[1].z * Local12.r);
