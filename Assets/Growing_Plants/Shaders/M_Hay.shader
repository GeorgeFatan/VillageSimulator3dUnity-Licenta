Shader "Unreal/M_Hay"
{
	Properties
	{
		...
		Material_Texture2D_0( "T_Hay_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Hay_BC", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.500000,0.000000,0.000000);//(Unknown) Brightness (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local3 = PositiveClampedPow(Local1.rgb,0.50000000);
	...
	MaterialFloat3 Local8 = (Local6.rgb * Material.ScalarExpressions[0].y);
